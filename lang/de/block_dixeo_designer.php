...
$string['eventcoursefinalized'] = 'Dixeo-Designer-Kurs finalisiert';
$string['eventcoursefinalizeddesc'] = 'Der Benutzer mit der ID \'{$a->userid}\' hat die Designer-Einreichung \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') in den Kurs \'{$a->courseid}\' finalisiert.';
$string['eventdraftcancelled'] = 'Dixeo-Designer-Entwurf abgebrochen';
$string['eventdraftcancelleddesc'] = 'Der Benutzer mit der ID \'{$a->userid}\' hat die Designer-Einreichung \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', deletestructure={$a->deletestructure}) abgebrochen.';
$string['eventgenerationstarted'] = 'Dixeo-Designer-Generierung gestartet';
$string['eventgenerationstarteddesc'] = 'Der Benutzer mit der ID \'{$a->userid}\' hat die Generierung für die Designer-Einreichung \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', draftcourseid={$a->courseid}) gestartet.';
$string['eventsubmissionfiledeleted'] = 'Dixeo-Designer-Quelldatei gelöscht';
$string['eventsubmissionfiledeleteddesc'] = 'Der Benutzer mit der ID \'{$a->userid}\' hat die Datei \'{$a->fileid}\' aus der Designer-Einreichung \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') gelöscht.';
$string['eventsubmissionfileuploaded'] = 'Dixeo-Designer-Quelldatei hochgeladen';
$string['eventsubmissionfileuploadeddesc'] = 'Der Benutzer mit der ID \'{$a->userid}\' hat {$a->filecount} Datei(en) zur Designer-Einreichung \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') hochgeladen.';
...
$string['privacy:metadata:email'] = 'E-Mail-Adresse der Nutzerin/des Nutzers, die/der den Kursdesigner verwendet.';
$string['privacy:metadata:external:files'] = 'Für die Kursgenerierung hochgeladene Quelldateien, die an Dixeo gesendet werden können.';
$string['privacy:metadata:externalpurpose'] = 'Designer-Prompts, Nutzeridentitätsfelder, Kursstrukturkontext und hochgeladene Quelldateien werden an Dixeo-Dienste gesendet, um Kurse zu erzeugen und zu verfeinern.';
$string['privacy:metadata:files'] = 'Vom Designer gespeicherte hochgeladene Quelldateien und generierte Kursbilder.';
$string['privacy:metadata:firstname'] = 'Vorname der Nutzerin/des Nutzers, die/der den Kursdesigner verwendet.';
$string['privacy:metadata:lastname'] = 'Nachname der Nutzerin/des Nutzers, die/der den Kursdesigner verwendet.';
$string['privacy:metadata:structure'] = 'Persistiertes Kursstruktur-JSON und zugehörige Metadaten zur Bildgenerierung.';
$string['privacy:metadata:structure:description'] = 'Eine kurze Beschreibung, die mit der Kursstruktur gespeichert wird.';
$string['privacy:metadata:structure:imageerror'] = 'Fehlerdetails der Kursbildgenerierung oder -bearbeitung.';
$string['privacy:metadata:structure:imagejobid'] = 'Die Remote-Jobkennung für die Kursbildgenerierung oder -bearbeitung.';
$string['privacy:metadata:structure:imagestatus'] = 'Der Status der Kursbildgenerierung oder -bearbeitung.';
$string['privacy:metadata:structure:jobid'] = 'Die lokale Designer-Jobkennung für die Struktur.';
$string['privacy:metadata:structure:structure'] = 'Das im Designer bearbeitete Kursstruktur-JSON.';
$string['privacy:metadata:submission'] = 'Designer-Einreichungsdatensätze (Prompt, Vorlage, Jobstatus, verknüpfter Kurs).';
$string['privacy:metadata:submission:courseid'] = 'Der aus der Designer-Einreichung erstellte Moodle-Kurs, sofern vorhanden.';
$string['privacy:metadata:submission:jobid'] = 'Die lokale Designer-Jobkennung.';
$string['privacy:metadata:submission:prompt'] = 'Die von der Nutzerin/dem Nutzer eingegebene Kursbeschreibung oder der Prompt.';
$string['privacy:metadata:submission:remotejobid'] = 'Die Remote-Dixeo-Jobkennung für asynchrone Vorgänge.';
$string['privacy:metadata:submission:status'] = 'Der Lebenszyklusstatus der Designer-Einreichung.';
$string['privacy:metadata:submission:templateid'] = 'Die Kennung der ausgewählten pedagogischen Vorlage.';
$string['privacy:metadata:timecreated'] = 'Der Zeitpunkt, zu dem der Datensatz erstellt wurde.';
$string['privacy:metadata:timemodified'] = 'Der Zeitpunkt der letzten Änderung des Datensatzes.';
$string['privacy:metadata:userid'] = 'Die ID der Nutzerin/des Nutzers, der/die die Designerdaten besitzt.';
$string['privacy:path:generatedimages'] = 'Generierte Kursbilder';
$string['privacy:path:structures'] = 'Kursstrukturen';
$string['privacy:path:submissions'] = 'Einreichungen';
