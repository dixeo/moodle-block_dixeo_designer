...
$string['cachedef_finalize_progress'] = 'Progression de finalisation du cours pour les tâches du concepteur';
$string['cachedef_prepare_progress'] = 'Progression de préparation du cours pour les tâches du concepteur';
...
$string['eventcoursefinalized'] = 'Cours du concepteur Dixeo finalisé';
$string['eventcoursefinalizeddesc'] = 'L\'utilisateur avec l\'id \'{$a->userid}\' a finalisé la soumission du concepteur \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') dans le cours \'{$a->courseid}\'.';
$string['eventdraftcancelled'] = 'Brouillon du concepteur Dixeo annulé';
$string['eventdraftcancelleddesc'] = 'L\'utilisateur avec l\'id \'{$a->userid}\' a annulé la soumission du concepteur \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', deletestructure={$a->deletestructure}).';
$string['eventgenerationstarted'] = 'Génération du concepteur Dixeo démarrée';
$string['eventgenerationstarteddesc'] = 'L\'utilisateur avec l\'id \'{$a->userid}\' a démarré la génération pour la soumission du concepteur \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', draftcourseid={$a->courseid}).';
$string['eventsubmissionfiledeleted'] = 'Fichier source du concepteur Dixeo supprimé';
$string['eventsubmissionfiledeleteddesc'] = 'L\'utilisateur avec l\'id \'{$a->userid}\' a supprimé le fichier \'{$a->fileid}\' de la soumission du concepteur \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
$string['eventsubmissionfileuploaded'] = 'Fichier source du concepteur Dixeo téléversé';
$string['eventsubmissionfileuploadeddesc'] = 'L\'utilisateur avec l\'id \'{$a->userid}\' a téléversé {$a->filecount} fichier(s) vers la soumission du concepteur \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
...
$string['privacy:metadata:email'] = 'L’adresse e-mail de l’utilisateur utilisant le concepteur de cours.';
$string['privacy:metadata:external:files'] = 'Fichiers sources téléversés pour la génération de cours pouvant être envoyés à Dixeo.';
$string['privacy:metadata:externalpurpose'] = 'Les prompts du concepteur, les champs d’identité utilisateur, le contexte de structure de cours et les fichiers sources téléversés sont envoyés aux services Dixeo pour générer et affiner des cours.';
$string['privacy:metadata:files'] = 'Fichiers sources téléversés et images de cours générées stockés par le concepteur.';
$string['privacy:metadata:firstname'] = 'Le prénom de l’utilisateur utilisant le concepteur de cours.';
$string['privacy:metadata:lastname'] = 'Le nom de famille de l’utilisateur utilisant le concepteur de cours.';
$string['privacy:metadata:structure'] = 'JSON de structure de cours persisté et métadonnées associées de génération d’images.';
$string['privacy:metadata:structure:description'] = 'Une courte description stockée avec la structure du cours.';
$string['privacy:metadata:structure:imageerror'] = 'Détails d’erreur de la génération ou de l’édition de l’image du cours.';
$string['privacy:metadata:structure:imagejobid'] = 'L’identifiant distant du travail pour la génération ou l’édition de l’image du cours.';
$string['privacy:metadata:structure:imagestatus'] = 'Le statut de la génération ou de l’édition de l’image du cours.';
$string['privacy:metadata:structure:jobid'] = 'L’identifiant local du travail du concepteur pour la structure.';
$string['privacy:metadata:structure:structure'] = 'Le JSON de structure de cours modifié dans le concepteur.';
$string['privacy:metadata:submission'] = 'Enregistrements de soumission du concepteur (prompt, modèle, statut du travail, cours lié).';
$string['privacy:metadata:submission:courseid'] = 'Le cours Moodle créé à partir de la soumission du concepteur, lorsqu’il est disponible.';
$string['privacy:metadata:submission:jobid'] = 'L’identifiant local du travail du concepteur.';
$string['privacy:metadata:submission:prompt'] = 'La description du cours ou le prompt saisi par l’utilisateur.';
$string['privacy:metadata:submission:remotejobid'] = 'L’identifiant distant du travail Dixeo pour les opérations asynchrones.';
$string['privacy:metadata:submission:status'] = 'Le statut du cycle de vie de la soumission du concepteur.';
$string['privacy:metadata:submission:templateid'] = 'L’identifiant du modèle pédagogique sélectionné.';
$string['privacy:metadata:timecreated'] = 'L’heure de création de l’enregistrement.';
$string['privacy:metadata:timemodified'] = 'L’heure de dernière modification de l’enregistrement.';
$string['privacy:metadata:userid'] = 'L’ID de l’utilisateur propriétaire des données du concepteur.';
$string['privacy:path:generatedimages'] = 'Images de cours générées';
$string['privacy:path:structures'] = 'Structures de cours';
$string['privacy:path:submissions'] = 'Soumissions';
