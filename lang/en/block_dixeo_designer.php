...
$string['cachedef_finalize_progress'] = 'Course finalization progress for designer jobs';
$string['cachedef_prepare_progress'] = 'Course preparation progress for designer jobs';
...
$string['eventcoursefinalized'] = 'Dixeo designer course finalized';
$string['eventcoursefinalizeddesc'] = 'The user with id \'{$a->userid}\' finalized designer submission \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') into course \'{$a->courseid}\'.';
$string['eventdraftcancelled'] = 'Dixeo designer draft cancelled';
$string['eventdraftcancelleddesc'] = 'The user with id \'{$a->userid}\' cancelled designer submission \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', deletestructure={$a->deletestructure}).';
$string['eventgenerationstarted'] = 'Dixeo designer generation started';
$string['eventgenerationstarteddesc'] = 'The user with id \'{$a->userid}\' started generation for designer submission \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', draftcourseid={$a->courseid}).';
$string['eventsubmissionfiledeleted'] = 'Dixeo designer source file deleted';
$string['eventsubmissionfiledeleteddesc'] = 'The user with id \'{$a->userid}\' deleted file \'{$a->fileid}\' from designer submission \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
$string['eventsubmissionfileuploaded'] = 'Dixeo designer source file uploaded';
$string['eventsubmissionfileuploadeddesc'] = 'The user with id \'{$a->userid}\' uploaded {$a->filecount} file(s) to designer submission \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
...
$string['privacy:metadata:email'] = 'The email address of the user using the course designer.';
$string['privacy:metadata:external:files'] = 'Source files uploaded for course generation that may be sent to Dixeo.';
$string['privacy:metadata:externalpurpose'] = 'Designer prompts, user identity fields, course structure context, and uploaded source files are sent to Dixeo services to generate and refine courses.';
$string['privacy:metadata:files'] = 'Uploaded source files and generated course images stored by the designer.';
$string['privacy:metadata:firstname'] = 'The first name of the user using the course designer.';
$string['privacy:metadata:lastname'] = 'The last name of the user using the course designer.';
$string['privacy:metadata:structure'] = 'Persisted course structure JSON and related image generation metadata.';
$string['privacy:metadata:structure:description'] = 'A short description stored with the course structure.';
$string['privacy:metadata:structure:imageerror'] = 'Error details from course image generation or editing.';
$string['privacy:metadata:structure:imagejobid'] = 'The remote job id for course image generation or editing.';
$string['privacy:metadata:structure:imagestatus'] = 'The status of course image generation or editing.';
$string['privacy:metadata:structure:jobid'] = 'The local designer job identifier for the structure.';
$string['privacy:metadata:structure:structure'] = 'The course structure JSON edited in the designer.';
$string['privacy:metadata:submission'] = 'Designer submission records (prompt, template, job status, linked course).';
$string['privacy:metadata:submission:courseid'] = 'The Moodle course created from the designer submission, when available.';
$string['privacy:metadata:submission:jobid'] = 'The local designer job identifier.';
$string['privacy:metadata:submission:prompt'] = 'The course description or prompt entered by the user.';
$string['privacy:metadata:submission:remotejobid'] = 'The remote Dixeo job identifier for async operations.';
$string['privacy:metadata:submission:status'] = 'The lifecycle status of the designer submission.';
$string['privacy:metadata:submission:templateid'] = 'The selected pedagogical template identifier.';
...
$string['privacy:metadata:userid'] = 'The ID of the user who owns the designer data.';
$string['privacy:path:generatedimages'] = 'Generated course images';
$string['privacy:path:structures'] = 'Course structures';
