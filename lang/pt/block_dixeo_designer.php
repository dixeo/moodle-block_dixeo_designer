...
$string['cachedef_finalize_progress'] = 'Progresso de finalização do curso para trabalhos do designer';
$string['cachedef_prepare_progress'] = 'Progresso de preparação do curso para trabalhos do designer';
...
$string['eventcoursefinalized'] = 'Curso do designer Dixeo finalizado';
$string['eventcoursefinalizeddesc'] = 'O utilizador com id \'{$a->userid}\' finalizou a submissão do designer \'{$a->submissionid}\' (jobid=\'{$a->jobid}\') no curso \'{$a->courseid}\'.';
$string['eventdraftcancelled'] = 'Rascunho do designer Dixeo cancelado';
$string['eventdraftcancelleddesc'] = 'O utilizador com id \'{$a->userid}\' cancelou a submissão do designer \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', deletestructure={$a->deletestructure}).';
$string['eventgenerationstarted'] = 'Geração do designer Dixeo iniciada';
$string['eventgenerationstarteddesc'] = 'O utilizador com id \'{$a->userid}\' iniciou a geração da submissão do designer \'{$a->submissionid}\' (jobid=\'{$a->jobid}\', draftcourseid={$a->courseid}).';
$string['eventsubmissionfiledeleted'] = 'Ficheiro fonte do designer Dixeo eliminado';
$string['eventsubmissionfiledeleteddesc'] = 'O utilizador com id \'{$a->userid}\' eliminou o ficheiro \'{$a->fileid}\' da submissão do designer \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
$string['eventsubmissionfileuploaded'] = 'Ficheiro fonte do designer Dixeo carregado';
$string['eventsubmissionfileuploadeddesc'] = 'O utilizador com id \'{$a->userid}\' carregou {$a->filecount} ficheiro(s) para a submissão do designer \'{$a->submissionid}\' (jobid=\'{$a->jobid}\').';
...
$string['privacy:metadata:email'] = 'O endereço de e-mail do utilizador que usa o designer de cursos.';
$string['privacy:metadata:external:files'] = 'Ficheiros de origem carregados para a geração do curso que podem ser enviados para a Dixeo.';
$string['privacy:metadata:externalpurpose'] = 'Os prompts do designer, os campos de identidade do utilizador, o contexto da estrutura do curso e os ficheiros de origem carregados são enviados para os serviços Dixeo para gerar e aperfeiçoar cursos.';
$string['privacy:metadata:files'] = 'Ficheiros de origem carregados e imagens de curso geradas armazenados pelo designer.';
$string['privacy:metadata:firstname'] = 'O primeiro nome do utilizador que usa o designer de cursos.';
$string['privacy:metadata:lastname'] = 'O apelido do utilizador que usa o designer de cursos.';
$string['privacy:metadata:structure'] = 'JSON da estrutura do curso persistido e metadados relacionados de geração de imagens.';
$string['privacy:metadata:structure:description'] = 'Uma breve descrição armazenada com a estrutura do curso.';
$string['privacy:metadata:structure:imageerror'] = 'Detalhes de erro da geração ou edição da imagem do curso.';
$string['privacy:metadata:structure:imagejobid'] = 'O id do trabalho remoto para a geração ou edição da imagem do curso.';
$string['privacy:metadata:structure:imagestatus'] = 'O estado da geração ou edição da imagem do curso.';
$string['privacy:metadata:structure:jobid'] = 'O identificador local do trabalho do designer para a estrutura.';
$string['privacy:metadata:structure:structure'] = 'O JSON da estrutura do curso editado no designer.';
$string['privacy:metadata:submission'] = 'Registos de submissão do designer (prompt, modelo, estado do trabalho, curso associado).';
$string['privacy:metadata:submission:courseid'] = 'O curso Moodle criado a partir da submissão do designer, quando disponível.';
$string['privacy:metadata:submission:jobid'] = 'O identificador local do trabalho do designer.';
$string['privacy:metadata:submission:prompt'] = 'A descrição do curso ou o prompt introduzido pelo utilizador.';
$string['privacy:metadata:submission:remotejobid'] = 'O identificador remoto do trabalho Dixeo para operações assíncronas.';
$string['privacy:metadata:submission:status'] = 'O estado do ciclo de vida da submissão do designer.';
$string['privacy:metadata:submission:templateid'] = 'O identificador do modelo pedagógico selecionado.';
$string['privacy:metadata:timecreated'] = 'A hora em que o registo foi criado.';
$string['privacy:metadata:timemodified'] = 'A hora em que o registo foi modificado pela última vez.';
$string['privacy:metadata:userid'] = 'O ID do utilizador que possui os dados do designer.';
$string['privacy:path:generatedimages'] = 'Imagens de curso geradas';
$string['privacy:path:structures'] = 'Estruturas de curso';
